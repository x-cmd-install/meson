...
合计: **151,388** 行代码（覆盖前 5 种语言、共 **3609** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Python | 101,817 | 9,900 | 17,869 | 562 |
...
- **Star**: 6,627 · **Fork**: 1,939 · **开放 issue**: 6,670 · **贡献者**: 1,007

## 累计统计

- **发布数**: 190 · **已合并 PR**: 7140 · **开放 PR**: 512 · **已关闭 issue**: 4918 · **开放 issue**: 1752 · **提交数**: 17858
...
在 [repology.org](https://repology.org/project/meson) 上共有 **353** 个发行版报告此项目。**60** 个 ✅ 已是最新上游版本，**202** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T21:06:00Z._
